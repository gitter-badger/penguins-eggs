...
class Eggs extends Fabricator {
  constructor(homeDir = "/home/artisan/fabricator", distroName = "default") {
    ...
    // Variabili Eggs
    this._clientHostName = "littlebird"; // $CLIENT_HOSTNAME
  ...
  MENU LABEL little-bird
    KERNEL little-bird/vmlinuz-$KERNEL
    APPEND root=/dev/nfs initrd=little-bird/initrd.img-$KERNEL nfsroot=$BOOTSERVER_ADDRESS:/srv/eggs/littlebird  ip=dhcp rw
  	IPAPPEND 3

...
#read -p "Adesso puoi avviare un qualsiasi pc dalla rete via pxe con questa distribuzione. Premi un tasto per continuare..."`;
  ...
  tempInstallerFinalize(){
    execAndShow(`mkdir /var/www/html/${this._distroName}`);
    execAndShow(`mv /srv/eggs/littlebird/tmp/initrd.img-${this._kernelVer}  /var/www/html/${this._distroName}`);
    execAndShow(`cp /boot/vmlinuz-${this._kernelVer}  /var/www/html/${this._distroName}`);
    execAndShow(`chmod -R 777  /var/www/html`);
  }
